...
int Console::draw(Screen* screen){
    int start = m_history.size()>m_nb_visible_lines?m_history.size()-m_nb_visible_lines:0;
    for(int x=start;x<m_history.size();x++){
...
void Console::create_entry(Screen* screen){
    ...
    tmp_button->set_contour_color(100, 100, 100);
